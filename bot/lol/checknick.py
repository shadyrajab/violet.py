...
class CheckNick(commands.Cog):
    ...
    async def lolchecknick(self, ctx, server, *, username):
        summoner = requests.get(f'https://{server}.api.riotgames.com/lol/summoner/v4/summoners/by-name/{username}?api_key=RGAPI-eaf140b8-79c7-41c3-8958-e4a3e3a731bd').json()
